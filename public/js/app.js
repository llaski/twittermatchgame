...
var strictUriEncode = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_Form__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_Arr__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_query_string__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = {
    data: function data() {
        return {
            ...
            gameDataId: null,
            gameDataTweets: [],
            form: new __WEBPACK_IMPORTED_MODULE_1__lib_Form__["a" /* default */]({
                name: '',
                email: '',
                time: null,
                results: []
    ...
    computed: {
        numItemsMatched: function numItemsMatched() {
            return this.gameDataTweets.filter(function (item) {
                return item.matched;
            }).length;
        },
        allItemsMatched: function allItemsMatched() {
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__API__["a" /* default */].startGame().then(function (data) {
            _this.loading = false;
            _this.setInitialGameData(data);
    ...
    methods: {
        ...
        initDroppable: function initDroppable() {
            var _this2 = this;
            ...
            window.$('.tweet-item').droppable({
                ...
                drop: function drop(event, ui) {
                    var handle = ui.draggable.get(0).dataset.handle;
                    var tweet = event.target.dataset.tweet;

                    //Try to find an item that matches the chosen handle and tweet
                    var matchedGameTweetItem = _this2.gameDataTweets.find(function (item) {
                        return item.tweet === tweet && item.handle === handle;
                    });
                    ...
                    if (matchedGameTweetItem) {
                        ...
                        if (matchedGameTweetItem.randomHandle !== handle) {
                            var swampGameDataTweetItem = _this2.gameDataTweets.find(function (item) {
                                return item.randomHandle === handle && !item.matched;
                            });
        ...
        setInitialGameData: function setInitialGameData(data) {
            this.gameDataId = data.id;

            var randomizedHandles = __WEBPACK_IMPORTED_MODULE_2__lib_Arr__["a" /* default */].shuffle(data.tweets.map(function (item) {
                return item.handle;
            }));
            ...
            this.gameDataTweets = data.tweets.map(function (item, index) {
        ...
        onSubmit: function onSubmit() {
            ...
            this.form.results = this.gameDataTweets.reduce(function (carry, item) {
                if (item.matched) {
            ...
            this.form.submit('/api/games/' + this.gameDataId, 'PUT').then(function (responseData) {
                _this4.$router.push('leaderboard?' + __WEBPACK_IMPORTED_MODULE_3_query_string___default.a.stringify(responseData));
            }).catch(function (error) {
                console.log(error);
            });
        }
    ...
    filters: {
        secsToMins: function secsToMins(seconds) {
            var mins = Math.floor(seconds / 60);
            var formattedSecs = seconds % 60;
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__API__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_query_string__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__API__["a" /* default */].getLeaderboard().then(function (data) {
            _this.loading = false;
    ...
    methods: {
        initHighlightedGame: function initHighlightedGame() {
            ...
            var highlightedGame = this.games.find(function (game) {
                return game.id === parseInt(query.id);
            });
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        key: 'submit',
        value: function submit(url, requestType) {
            var _this = this;
...
Component.options.__file = "/Users/LarryLaski/Sites/twittermatchgame/resources/assets/js/views/Game.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7e2466e4", Component.options)
  } else {
    hotAPI.reload("data-v-7e2466e4", Component.options)
  }
})()}
...
Component.options.__file = "/Users/LarryLaski/Sites/twittermatchgame/resources/assets/js/views/Home.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6ac65d5e", Component.options)
  } else {
    hotAPI.reload("data-v-6ac65d5e", Component.options)
  }
})()}
...
Component.options.__file = "/Users/LarryLaski/Sites/twittermatchgame/resources/assets/js/views/Leaderboard.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6dc408fb", Component.options)
  } else {
    hotAPI.reload("data-v-6dc408fb", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6ac65d5e", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Twitter Match Game")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', {
    staticClass: "thead-inverse"
  }, [_c('tr', [_c('th', [_vm._v("Rank")]), _vm._v(" "), _c('th', [_vm._v("Name")]), _vm._v(" "), _c('th', [_vm._v("# of Correct Matches")]), _vm._v(" "), _c('th', [_vm._v("Time")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6dc408fb", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return (!_vm.loading) ? _c('div', {
      ...
      staticClass: "col drag-item handle-item",
      attrs: {
        "data-handle": item.randomHandle
      }
    }, [_c('p', [_vm._v(_vm._s(item.randomHandle))])]) : _vm._e(), _vm._v(" "), _c('div', {
      staticClass: "col drag-item tweet-item",
      class: {
        matched: item.matched
      },
      attrs: {
        "data-tweet": item.tweet
      }
    }, [(item.matched) ? _c('p', [_vm._v(_vm._s(item.handle))]) : _vm._e(), _vm._v(" "), _c('p', [_vm._v(_vm._s(item.tweet))])])])]) : _vm._e()
  }), _vm._v(" "), (!_vm.loading && _vm.gameComplete) ? _c('div', {
    staticClass: "row"
  }, [_c('div', {
  ...
  }, [(_vm.allItemsMatched) ? _c('p', [_vm._v("Congrats! You completed the game in " + _vm._s(_vm._f("secsToMins")(_vm.timeRemaining)) + ".")]) : _vm._e(), _vm._v(" "), (!_vm.allItemsMatched) ? _c('p', [_vm._v("Sorry - You ran out of time! You completed " + _vm._s(_vm.numItemsMatched) + " of " + _vm._s(_vm.gameDataTweets.length))]) : _vm._e(), _vm._v(" "), _c('p', [_vm._v("Submit your results to see where you stack up on the leaderboard!")]), _vm._v(" "), _c('div', {
  ...
  }) : _vm._e()]), _vm._v(" "), _vm._m(0)])])]) : _vm._e()], 2)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "form-group"
  }, [_c('input', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7e2466e4", module.exports)
  }
}
